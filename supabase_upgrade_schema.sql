...
-- This script safely creates all missing tables/views and updates 
-- the 'students' table with missing columns and relational keys.
-- ====================================================================
...
-- 3. CREATE GROUPS TABLE (If not exists)
...
-- 4. CREATE SCHEDULES TABLE (If not exists)
...
-- 5. CREATE SYSTEM USERS TABLE (If not exists)
...
-- 6. CREATE GROUP OCCUPANCY TABLE (If not exists)
...
-- 7. CREATE BILLING TRANSACTIONS TABLE (If not exists)
...
-- 8. CREATE CLASSES TABLE (If not exists)
...
-- 9. CREATE TEACHER AVAILABILITY TABLE (If not exists)
...
-- 10. CREATE RECENT ACTIVITIES TABLE (If not exists)
...
-- 11. UPGRADE STUDENTS TABLE (Safely add columns and foreign keys)
...
-- Relational keys referencing other tables (which are now created first!)
